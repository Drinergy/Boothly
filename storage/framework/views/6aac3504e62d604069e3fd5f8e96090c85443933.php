...
<head>
    ...
    <title>Boothly - Photobooth</title>
        ...
        class Photobooth {
            ...
            async capturePhoto() {
                try {
                    ...
                    const response = await fetch('<?php echo e(route("photobooth.capture")); ?>', {
                        method: 'POST',
                        headers: {
            ...
            async createCollage() {
                ...
                try {
                    const response = await fetch('<?php echo e(route("photobooth.collage")); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
...
</html> <?php /**PATH C:\xampp\htdocs\photobooth\resources\views/photobooth/index.blade.php ENDPATH**/ ?>